...
public class BaseCommandHelp<T> extends ArrayList<T> implements CommandHelp<T> {
    ...
    public static final class Resolver implements ParameterResolver.ContextResolver<CommandHelp<?>> {
